...
* L'odds dei pazienti con un dolore al petto sintomatico è inferiore di circa l'88% rispetto a quelli con un dolore asintomatico; ciò significa che la probabilità di avere una cardiopatia è minore per quei pazienti che presentano un dolore al petto sintomatico.
